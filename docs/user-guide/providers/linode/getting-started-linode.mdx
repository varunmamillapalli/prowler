...
- The token requires at minimum: `account:read_only`, `linodes:read_only`, `firewall:read_only`, `nodebalancers:read_only`, `volumes:read_only`, `object_storage:read_only`, `lke:read_only`, and `databases:read_only` scopes
