...
| `Firewalls` | `Read Only` | Required to list firewalls and their rules |
| `NodeBalancers` | `Read Only` | Required to list NodeBalancers and their configurations |
| `Volumes` | `Read Only` | Required to list Block Storage volumes |
| `Object Storage` | `Read Only` | Required to list Object Storage buckets and keys |
| `Kubernetes` | `Read Only` | Required to list LKE clusters and node pools |
| `Databases` | `Read Only` | Required to list managed database instances |
...
4. Configure the token:
   ...
   - **Permissions:** Set the following scopes to **Read Only**:
     ...
     - Volumes
     - Object Storage
     - Kubernetes (Linode Kubernetes Engine)
     - Databases
